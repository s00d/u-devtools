...
<template>
  ...
  >
    ...
    <div
      class="relative w-[500px] bg-gray-800 rounded-lg shadow-2xl overflow-hidden flex flex-col max-h-[60vh] animate-fade-in"
    >
      <div class="p-3 border-b border-gray-700">
        <div class="relative">
          <UIcon name="MagnifyingGlass" class="absolute left-3 top-2.5 text-gray-500 w-5 h-5" />
          <input
            ref="inputRef"
            v-model="search"
            class="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-indigo-400 text-gray-200 placeholder-gray-500"
        ...
        >
          ...
          <div v-if="cmd.shortcut" class="flex gap-1">
            <span
              ...
              :key="k"
              class="bg-gray-600/50 px-1.5 rounded text-xs font-mono"
            >
              {{ k }}
            </span>
          </div>
      ...
      <div class="bg-gray-700 border-t border-gray-600 px-3 py-1.5 text-xs text-gray-500 flex justify-between">
