...
This plugin is built with **Web Components (Lit)** and demonstrates Astro-style integration with Universal DevTools. This approach mirrors the native way Astro builds its own Dev Toolbar extensions.
