...
This plugin is built with **Web Components (Lit)** and demonstrates Lit integration with Universal DevTools. This approach uses LitElement for building custom elements that work seamlessly with Vue components from `@u-devtools/ui`.
