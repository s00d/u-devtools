...
[Universal DevTools Kit SDK](../../packages.md) / @u-devtools/plugin-vite-inspector
...
- [viteInspectorState](variables/viteInspectorState.md)

## Functions

- [viteInspectorPlugin](functions/viteInspectorPlugin.md)
